...
export default function HomePageManagement() {
      ...
      case "products":
        return (
          <ProductSectionTab
            ...
            canEdit={canEdit}
            onUpdate={() => setActiveTab("products")}
          />
        );
      case "clients":
        return (
  ...
  return (
    <div className="py-6 px-6 mt-10 lg:w-[980px]">
          ...
          <div className="relative">
            <button
              className={`py-2 text-sm cursor-pointer ${
                activeTab === "hero" ? "text-font font-medium" : "text-gray-500"
              }`}
