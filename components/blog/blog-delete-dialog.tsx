      ...
      <DrawerAlertDialog
        trigger={
          <Button
            variant="outline"
            size="sm"
            className="flex text-xs text-font items-center space-x-2 px-2 py-1 bg-white border-[1px] border-orange-200 hover:bg-red-700  hover:text-white rounded-lg cursor-pointer"
            disabled={isDeleting}
          >
